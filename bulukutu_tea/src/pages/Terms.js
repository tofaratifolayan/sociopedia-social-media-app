...
export default function Terms() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Bulukutu Tea, Cape Town.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Bulukutu Tea, accessible from{" "}
            <a
              href="www.bulukututea.com"
      ...
      <ul>
        <li>By email: info@bulukututea.com</li>
      </ul>
    </div>
  );
}
