  ...
  return (
    <div>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Bulukutu tea, Cape Town.
            </p>
          </li>
          <li>
            <p>
      ...
      <div className="text-center mb-5">
        <h1 className="m-5">Return and Refund Policies </h1>
        <h3 className="mt-5">
          for any information regarding refunds of any kind
        </h3>
        <h3>
          Please contact: <b>info@bulukututea.com</b>
        </h3>
      </div>
    </div>
  );
